...
use crate::output::moq_client::{
    MoqClientOutput, OutputMoqClientAudioOptions, OutputMoqClientVideoOptions,
};
use crate::*;
...
impl TryFrom<MoqClientOutput> for core::RegisterOutputOptions {
    ...
    fn try_from(value: MoqClientOutput) -> Result<Self, Self::Error> {
        let MoqClientOutput {
            endpoint_url,
            broadcast_path,
